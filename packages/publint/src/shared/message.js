...
export function formatMessage(m, pkg, opts = {}) {
  ...
  switch (m.code) {
    ...
    case 'USE_ENGINES_NODE':
      return `The package does not specify the ${h.bold('"engines.node"')} field. Consumers may install it on an unsupported Node.js version. Consider adding ${h.bold('"engines"')}: { ${h.bold('"node"')}: "${h.bold('>=18')}" } with your minimum supported version.`
    case 'USE_LICENSE':
