<template>
  ...
  >
    <div
      class="mb-2 px-8 flex flex-col md:flex-row w-full max-w-6xl mx-auto gap-8"
    >
      <section class="md:w-1/2 mb-2">
        <h2 class="mt-4! pt-0!">What is publint</h2>
        <p>
      ...
      <section class="md:w-1/2 mb-2">
        ...
        <p>
          ...
          <a href="https://npmjs.com">npmjs.com</a> or
    ...
    <div
      class="mb-8 px-8 flex flex-col md:flex-row w-full max-w-6xl mx-auto gap-8"
    >
      <section class="md:w-1/2 mb-2">
        <h2 class="mt-4! pt-0!">Use locally</h2>
        <ul>
          <li>
      ...
      <section class="md:w-1/2 mb-2">
        <h2 class="mt-4! pt-0!">Other resources</h2>
        <ul>
          <li>
            <a href="https://arethetypeswrong.github.io">
              Are the types wrong?
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://hirok.io/posts/package-json-exports">
