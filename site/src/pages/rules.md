...
The below lint rules are grouped by severity and then alphabetically. Some rules may dynamically downgrade to a lower severity, which will be mentioned accordingly.
