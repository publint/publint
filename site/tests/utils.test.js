...
test('normalizeGitUrl', () => {
  ...
  assert.equal(n('https://github.com/user/repo'), 'https://github.com/user/repo')

  // git+ prefix should be removed
  assert.equal(n('git+https://github.com/user/repo'), 'https://github.com/user/repo')
  assert.equal(n('git+https://github.com/user/repo.git'), 'https://github.com/user/repo')
  assert.equal(n('git+ssh://git@github.com/user/repo.git'), 'https://github.com/user/repo')

  // .git suffix should be removed
  assert.equal(n('https://github.com/user/repo.git'), 'https://github.com/user/repo')
  assert.equal(n('https://gitlab.com/user/repo.git'), 'https://gitlab.com/user/repo')
  assert.equal(n('https://bitbucket.org/user/repo.git'), 'https://bitbucket.org/user/repo')
  ...
  assert.equal(n('ssh://git@github.com/user/repo'), 'https://github.com/user/repo')
  assert.equal(n('ssh://git@github.com/user/repo.git'), 'https://github.com/user/repo')
  ...
  assert.equal(n('git+git://github.com/user/repo.git'), 'https://github.com/user/repo')
  assert.equal(n('git+ssh://git@gitlab.com/user/repo.git'), 'https://gitlab.com/user/repo')

  // Edge cases - URLs that don't match patterns should remain unchanged
  assert.equal(n('https://example.com/some/path'), 'https://example.com/some/path')
  assert.equal(
