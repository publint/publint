...
The project requires [`pnpm 11`](https://pnpm.io) and [`Node.js 22`](https://nodejs.org/en/) (or above). Run `pnpm install` to install dependencies of all workspace packages.
